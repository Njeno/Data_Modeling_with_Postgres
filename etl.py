...
def process_song_file(cur, filepath):
    """
      - Process for reading in a song file and extracting the data required for the song and artist table
      - Extraction of the relevant counts
      - and insertion into the corresponding tables in the database
...
def process_log_file(cur, filepath):
    """
    - Process for processing the JSON log files.
    - Filtering for "next song", as these are the relevant songs.
    - To differentiate between times, several columns are created after the datetime object has been set
    - User data frame is generated for database insertion
    - Songplay iterates over the data frame and writes the new mixed information into the database
...
def process_data(cur, conn, filepath, func):
    ...
    """
    - goes through the folder and
    - returns the full path for further processing
    """
